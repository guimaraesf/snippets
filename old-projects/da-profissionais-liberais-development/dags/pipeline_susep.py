...
# pipeline é um grupo de tarefas chamado `pipeline`, que contém três etapas: `extract-susep`, `transform-susep` e
# `load-susep`. Cada etapa é um `PySpark Job` submetido ao cluster Dataproc usando o operador
...
#         self.cluster_name = self.utils.customize_cluster_name(self.get_cluster_id, "susep", "-")
#     @staticmethod
...
#             for step in ("extract-susep", "transform-susep", "load-susep")
#         ]
...
#             pipeline = self.create_pipeline("pipeline", "superintendencia-seguros-privados", dag)
#             delete_gcs_objects = self.delete_gcs_objects(
#                 "delete_files",
#                 ["transient/superintendencia-seguros-privados"],
#                 dag,
#             )
...
# # ================================================================================================
# SQUAD = "dados-alternativos"
# DAG_ID = "da_profissionais_liberais_pipeline_susep"
