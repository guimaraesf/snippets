...
# ================================================================================================
# Module: main_cronjob_bolsa_pagamentos.py
# Author: Fernando Theodoro Guimarães
# E-mail: fernando.guimaraes@boavistascpc.com.br
# Description: This code captures and stores data related to Bolsa Família - Pagamentos
# Value Stream: Data
...
class ProcessRunner:
    ...
    def get_url(self):
        ...
        """
        url = f"https://www.portaldatransparencia.gov.br/download-de-dados/bolsa-familia-pagamentos/{self.target_date}"
        return url
    ...
    def get_download_path(self):
        ...
        """
        download_path = os.path.join(self.local_dir,
                                     f"bolsafamilia_pagamentos{self.target_date}.zip")
    ...
    def get_blobs_to_validate(self, bucket):
        ...
        """
        prefix = "BOLSAFAMILIA/PAGAMENTOS/ENTRADA"
    ...
    def get_file_blob_map(self):
        ...
        """
        file_blob_map = {
            f"{self.target_date}_BolsaFamilia_Pagamentos": "BOLSAFAMILIA/PAGAMENTOS/ENTRADA/"
        }
    ...
    def run(self):
        ...
        if not file_exists_in_bucket:
            self.logger.info(
                f"Starting the download for the Bolsa Família - Pagamentos social benefit from {self.target_date_name}.")
...
def main():
    ...
    files = ["BolsaFamilia_Pagamentos.csv"]
