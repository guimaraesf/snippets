...
# Description: This code captures and stores data related to Novo Bolsa Família
# Value Stream: Data
...
class ProcessRunner:
    ...
    def get_url(self):
        ...
        """
        url = f"https://www.portaldatransparencia.gov.br/download-de-dados/novo-bolsa-familia/{self.target_date}"
        return url
    ...
    def get_download_path(self):
        ...
        """
        download_path = os.path.join(self.local_dir, f"novo_bolsa_familia{self.target_date}.zip")
    ...
    def get_blobs_to_validate(self, bucket):
        ...
        """
        prefix = "BOLSAFAMILIA/NOVO/ENTRADA"
    ...
    def get_file_blob_map(self):
        ...
        """
        file_blob_map = {
            f"{self.target_date}_NovoBolsaFamilia.csv": "BOLSAFAMILIA/NOVO/ENTRADA/"
        }
    ...
    def run(self):
        ...
        if not file_exists_in_bucket:
            self.logger.info(
                f"Starting the download for the Novo Bolsa Família social benefit from {self.target_date_name}.")
