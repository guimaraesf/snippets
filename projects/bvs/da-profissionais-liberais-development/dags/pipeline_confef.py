...
# !/usr/bin/env python3
# ================================================================================================
# Module: pipeline_confef.py
# Author: Fernando Theodoro Guimarães
# E-mail: fernando.guimaraes@boavistascpc.com.br
# Description: This module is responsible for orchestrating the Superintendencia Seguro Privado pipeline.
# Value Stream: Data
...
# pipeline é um grupo de tarefas chamado `pipeline`, que contém três etapas: `extract-confef`, `transform-confef` e
# `load-confef`. Cada etapa é um `PySpark Job` submetido ao cluster Dataproc usando o operador
...
#         self.cluster_name = self.utils.customize_cluster_name(self.get_cluster_id, "confef", "-")
#     @staticmethod
...
#             for step in ("extract-confef", "transform-confef", "load-confef")
#         ]
...
#             pipeline = self.create_pipeline("pipeline", "conselho-federal-educacao-fisica", dag)
#             delete_gcs_objects = self.delete_gcs_objects(
#                 "delete_files",
#                 ["transient/conselho-federal-educacao-fisica"],
#                 dag,
#             )
...
# # ================================================================================================
# SQUAD = "dados-alternativos"
# DAG_ID = "da_profissionais_liberais_pipeline_confef"
