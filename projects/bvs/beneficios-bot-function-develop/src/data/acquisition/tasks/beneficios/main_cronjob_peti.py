...
# ================================================================================================
# Module: main_cronjob_peti.py
# Author: Fernando Theodoro Guimarães
# E-mail: fernando.guimaraes@boavistascpc.com.br
# Description: This code captures and stores data related to PETI payments
# Value Stream: Data
...
class ProcessRunner:
    ...
    def get_url(self):
        ...
        """
        url = f"https://www.portaldatransparencia.gov.br/download-de-dados/peti/{self.target_date}"
        return url
    ...
    def get_download_path(self):
        ...
        """
        download_path = os.path.join(self.local_dir, f"peti{self.target_date}.zip")
    ...
    def get_file_blob_map(self):
        ...
        """
        file_blob_map = {f"{self.target_date}_PETI": "PETI/ENTRADA/"}
    ...
    def run(self):
        ...
        if not file_exists_in_bucket:
            self.logger.info(
                f"Starting the download for the PETI social benefit from {self.target_date_name}."
            )
