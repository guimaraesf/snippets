...
# ================================================================================================
# Module: main_cronjob_garantia_safra.py
# Author: Fernando Theodoro Guimarães
# E-mail: fernando.guimaraes@boavistascpc.com.br
# Description: This code captures and stores data related to Garantia Safra payments
# Value Stream: Data
...
class ProcessRunner:
    ...
    def get_url(self):
        ...
        """
        url = f"https://www.portaldatransparencia.gov.br/download-de-dados/garantia-safra/{self.target_date}"
        return url
    ...
    def get_file_blob_map(self):
        ...
        """
        file_blob_map = {
            f"{self.target_date}_GarantiaSafra.csv": "GARANTIASAFRA/ENTRADA/"
        }
