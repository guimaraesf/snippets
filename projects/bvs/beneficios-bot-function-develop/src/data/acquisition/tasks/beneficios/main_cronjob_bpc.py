...
# ================================================================================================
# Module: main_cronjob_bpc.py
# Author: Fernando Theodoro Guimarães
# E-mail: fernando.guimaraes@boavistascpc.com.br
# Description: This code captures and stores data related to BPC payments
# Value Stream: Data
...
class ProcessRunner:
    ...
    def get_url(self):
        ...
        """
        url = f"https://www.portaldatransparencia.gov.br/download-de-dados/bpc/{self.target_date}"
        return url
    ...
    def get_download_path(self):
        ...
        """
        download_path = os.path.join(self.local_dir, f"bpc{self.target_date}.zip")
    ...
    def get_file_blob_map(self):
        ...
        """
        file_blob_map = {f"{self.target_date}_BPC.csv": "BPC/ENTRADA/"}
    ...
    def run(self):
        ...
        if not file_exists_in_bucket:
            self.logger.info(
                f"Starting the download for the BPC social benefit from {self.target_date_name}."
            )
