...
# ================================================================================================
# Module: main_cronjob_bolsa_saques.py
# Author: Fernando Theodoro Guimarães
# E-mail: fernando.guimaraes@boavistascpc.com.br
# Description: This code captures and stores data related to Bolsa Família - Saques
# Value Stream: Data
...
class ProcessRunner:
    ...
    def get_url(self):
        ...
        """
        url = f"https://www.portaldatransparencia.gov.br/download-de-dados/bolsa-familia-saques/{self.target_date}"
        return url
    ...
    def get_download_path(self):
        ...
        """
        download_path = os.path.join(self.local_dir, f"bolsafamilia_saques{self.target_date}.zip")
    ...
    def get_blobs_to_validate(self, bucket):
        ...
        """
        prefix = "BOLSAFAMILIA/SAQUES/ENTRADA"
    ...
    def get_file_blob_map(self):
        ...
        """
        file_blob_map = {
            f"{self.target_date}_BolsaFamilia_Saques": "BOLSAFAMILIA/SAQUES/ENTRADA/"
        }
    ...
    def run(self):
        ...
        if not file_exists_in_bucket:
            self.logger.info(
                f"Starting the download for the Bolsa Família - Saques social benefit from {self.target_date_name}.")
