...
class ProcessRunner:
    ...
    def get_download_path(self):
        ...
        """
        download_path = os.path.join(self.local_dir, f"Servidores_Orgao_{self.target_date}.zip")
    ...
    def append_file_blob_map(self, new_file_name, file_blob_map, structure_dir):
        ...
        """
        file_blob_map[new_file_name] = f"SERVIDORES/ESTADUAIS/STAGING/DF/ORGAO/{structure_dir}"
